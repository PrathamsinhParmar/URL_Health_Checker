...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-uptime-monitor-secret-key-change-in-production-xyz123')
...
DEFAULT_FROM_EMAIL = 'prathamsinhparmar0@gmail.com'
